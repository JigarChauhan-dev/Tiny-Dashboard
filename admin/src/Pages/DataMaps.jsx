          ...
          <div className="container-fluid">
            <div className="row justify-content-center">
              <div className="col-12 col-lg-10 col-xl-10">
                <h2 className="page-title">Datamaps</h2>
                <p className="text-muted">
                  Customizable SVG map visualizations for the web in a single
                ...
                <div className="row">
                  <div className="col-12 mb-4">
                    <div className="card shadow">
                      <div className="card-body mt-n3">
                        <h6 className="card-title my-3">World Datamap</h6>
                        <div
                          id="dataMapWorld"
                          style={{
                            position: "relative",
                  ...
                  <div className="col-md-6 mb-4">
                    <div className="card shadow">
                      <div className="card-header">
                        <strong className="card-title">USA Datamap</strong>
                      </div>
                  ...
                  <div className="col-md-6 mb-4">
                    <div className="card shadow">
                      <div className="card-header">
                        <strong className="card-title">Europe Datamap</strong>
                      </div>
                      <div className="card-body my-n3">
                        <div
                          id="dataMapEurope"
