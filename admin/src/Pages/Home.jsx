              ...
              <div className="card-body">
                <div className="row mt-1 align-items-center">
                  <div className="col-12 col-lg-4 text-left pl-4">
                    ...
                    <p className="text-muted mt-2"> Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui </p>
                  </div>
                  <div className="col-6 col-lg-2 text-center py-4">
                    <p className="mb-1 small text-muted">Today</p>
                    <span className="h3">$2600</span><br />
                    <span className="small text-muted">+20%</span>
                    <span className="fe fe-arrow-up text-success fe-12" />
                  </div>
                ...
                <div className="card-body mb-n3">
                  <div className="row items-align-baseline h-100">
                    <div className="col-md-6 my-3">
                      <p className="mb-0"><strong className="mb-0 text-uppercase text-muted">Earning</strong></p>
                      <h3>$2,562</h3>
                    ...
                    <div className="col-md-6 border-top py-3">
                      <p className="mb-1"><strong className="text-muted">Cost</strong></p>
                      <h4 className="mb-0">108</h4>
                      <p className="small text-muted mb-0"><span>37.7% Last week</span></p>
                    </div> {/* .col */}
                    <div className="col-md-6 border-top py-3">
                      <p className="mb-1"><strong className="text-muted">Revenue</strong></p>
                      <h4 className="mb-0">1168</h4>
                      <p className="small text-muted mb-0"><span>-18.9% Last week</span></p>
                    </div> {/* .col */}
                  </div>
                </div> {/* .card-body */}
              </div> {/* .card */}
          ...
          <div className="row">
            ...
            <div className="col-md-12 col-lg-4 mb-4">
              <div className="card timeline shadow">
                ...
                <div className="card-body" data-simplebar style={{height: 355, overflowY: 'auto', overflowX: 'hidden'}}>
                  <h6 className="text-uppercase text-muted mb-4">Today</h6>
                  <div className="pb-3 timeline-item item-primary">
                    <div className="pl-5">
                      <div className="mb-1"><strong>@Brown Asher</strong><span className="text-muted small mx-2">Just create new layout Index, form, table</span><strong>Tiny Admin</strong></div>
                  ...
                  <div className="pb-3 timeline-item item-warning">
                    <div className="pl-5">
                      <div className="mb-3"><strong>@Hester Nissim</strong><span className="text-muted small mx-2">has upload new files to</span><strong>Tiny Admin</strong></div>
                      <div className="row mb-3">
                        <div className="col"><img src="./assets/products/p1.jpg" alt="..." className="img-fluid rounded" /></div>
                        <div className="col"><img src="./assets/products/p2.jpg" alt="..." className="img-fluid rounded" /></div>
                        <div className="col"><img src="./assets/products/p3.jpg" alt="..." className="img-fluid rounded" /></div>
                        <div className="col"><img src="./assets/products/p4.jpg" alt="..." className="img-fluid rounded" /></div>
                      </div>
                  ...
                  <div className="pb-3 timeline-item item-success">
                    <div className="pl-5">
                      <div className="mb-3"><strong>@Kelley Sonya</strong><span className="text-muted small mx-2">has commented on</span><strong>Advanced table</strong></div>
                      <div className="card d-inline-flex mb-2">
                        <div className="card-body bg-light py-2 px-3 small rounded"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer dignissim nulla eu quam cursus placerat. Vivamus non odio ullamcorper, lacinia ante nec, blandit leo. </div>
                      </div>
                  ...
                  <div className="pb-3 timeline-item item-warning">
                    <div className="pl-5">
                      <div className="mb-3"><strong>@Fletcher Everett</strong><span className="text-muted small mx-2">created new group for</span><strong>Tiny Admin</strong></div>
                  ...
                  <div className="pb-3 timeline-item item-success">
                    <div className="pl-5">
                      <div className="mb-3"><strong>@Bertha Ball</strong><span className="text-muted small mx-2">has commented on</span><strong>Advanced table</strong></div>
                      <div className="card d-inline-flex mb-2">
                        <div className="card-body bg-light py-2 px-3"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer dignissim nulla eu quam cursus placerat. Vivamus non odio ullamcorper, lacinia ante nec, blandit leo. </div>
                      </div>
                      <p className="small text-muted">Back-End Development <span className="badge badge-light">1h ago</span>
                      </p>
                    </div>
                  ...
                  <div className="pb-3 timeline-item item-danger">
                    <div className="pl-5">
                      <div className="mb-3"><strong>@Lillith Joseph</strong><span className="text-muted small mx-2">has upload new files to</span><strong>Tiny Admin</strong></div>
                      <div className="row mb-3">
                        <div className="col"><img src="./assets/products/p4.jpg" alt="..." className="img-fluid rounded" /></div>
                        <div className="col"><img src="./assets/products/p1.jpg" alt="..." className="img-fluid rounded" /></div>
                        <div className="col"><img src="./assets/products/p2.jpg" alt="..." className="img-fluid rounded" /></div>
                  ...
                  <table className="table table-striped table-hover table-borderless">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div className="dropdown">
                            <button className="btn btn-sm dropdown-toggle more-vertical" type="button" id="dr1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="dropdown">
                            <button className="btn btn-sm dropdown-toggle more-vertical" type="button" id="dr2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <span className="text-muted sr-only">Action</span>
                            </button>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="dropdown">
                            <button className="btn btn-sm dropdown-toggle more-vertical" type="button" id="dr4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <span className="text-muted sr-only">Action</span>
                            </button>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="dropdown">
                            <button className="btn btn-sm dropdown-toggle more-vertical" type="button" id="dr5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <span className="text-muted sr-only">Action</span>
                            </button>
